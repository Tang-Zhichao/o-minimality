...
\begin{definition}
    Let $\mathbb{RCF}$ be the $\mathcal{L}_{or}$-theory axiomatized by the axioms for real closed fields and the axioms for ordered fields.
...
\begin{corollary}
    If $F \models \mathbb{RCF}$ and $A \subseteq F^n$ is semialgebraic,
...
\subsubsection{van den Dries's statements}
