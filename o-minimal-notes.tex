...
\usepackage[style=alphabetic,giveninits,maxbibnames=10]{kaobiblio}
\addbibresource{o-minimal.bib} % Bibliography file
...
\title[Notes on o-minimality]{Notes on o-minimality}

\author[ZT]{Zhichao Tang}
...
\begin{abstract}
\noindent
Notes on basic model theory and o-minimal GAGA theorems.
\end{abstract}

{\noindent\textbf{Keywords:} model theory, o-minimality, algebraic geometry}
